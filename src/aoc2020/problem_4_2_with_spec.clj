(ns aoc2020.problem-4-2-with-spec
  (:require [aoc2020.problem-4-1 :refer [sample-input-string input-string string->passport]]
            [aoc2020.problem-4-2 :refer [number-string? valid-height? invalid-strings valid-strings]]
