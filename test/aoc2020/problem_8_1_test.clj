(ns aoc2020.problem-8-1-test
  (:require [clojure.test :refer :all]
            ...
            [aoc2020.problem-8-1-with-iterate :refer :all]))
...
(deftest desc:solve-8-1
  (testing "예제 입력을 제공하면 누산기 값으로 5를 리턴합니다."
    (is (= 5 (:accumulator (solve-8-1 sample-input-strings)))))
  (testing "예제 입력을 제공하면 누산기 값으로 2025를 리턴합니다."
    (is (= 2025 (:accumulator (solve-8-1 input-strings))))))

(deftest desc:solve-8-1-with-iterate
  (testing "예제 입력을 제공하면 누산기 값으로 5를 리턴합니다."
    (is (= 5 (:accumulator (solve-8-1-with-iterate sample-input-strings)))))
  (testing "예제 입력을 제공하면 누산기 값으로 2025를 리턴합니다."
    (is (= 2025 (:accumulator (solve-8-1-with-iterate input-strings))))))
