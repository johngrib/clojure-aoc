(ns aoc2020.problem-4-2-test
  (:require [clojure.test :refer [deftest testing run-tests are is]]
            [aoc2020.problem-4-2 :refer [number-string? valid-height? validate-passport solve-4-2]]
