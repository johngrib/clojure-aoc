(ns aoc2018.problem-1-1-test
  (:require [clojure.test :refer [deftest testing is run-tests run-all-tests]]
            [aoc2018.problem-1-1 :refer [to-numbers solve-1-1 data-file]]))

(deftest describe:read-string
  (testing "read-string 함수는"
