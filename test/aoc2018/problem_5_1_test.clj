(ns aoc2018.problem-5-1-test
  (:require [clojure.test :refer [deftest testing are is]]
            [aoc2018.problem-5-1 :refer [pair-alphabet? react-polymer-reducer solve-5-1 sample-input-string input-string]]))
...
(deftest describe:react-polymer-reducer
  ...
  (testing "무시할 문자 set이 주어지면
    ...
    (are [무시할-문자-set, 입력-문자열, 예상되는-반응-결과]
         (= (reduce (react-polymer-reducer 무시할-문자-set) [] 입력-문자열)
            예상되는-반응-결과)
      #{\a} (seq "a") []
      #{\A \a} [] []
      #{\b \B} (seq "abA") []
