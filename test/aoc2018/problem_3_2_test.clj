(ns aoc2018.problem-3-2-test
  (:require [aoc2018.problem-3-1 :as problem]
            [aoc2018.problem-3-2 :refer [solve-3-2 collect-duplicated-dots]]
            [clojure.test :refer [deftest testing is are]]))

(deftest describe:collect-duplicated-dots
  (testing
   "collect-duplicated-dots 함수는 주어진 점들의 리스트에서, 중복된 위치를 갖는 점을 수집해 리턴합니다"
    (are [all-dots result]
...
(deftest describe:solve-3-2
  (testing "solve-3-2 함수는"
    (let [sample-string ["#1 @ 1,3: 4x4"
                         "#2 @ 3,1: 4x4"
                         "#3 @ 5,5: 2x2"]]
      (testing "https://adventofcode.com/2018/day/3 에 올라온 part1 예제를 제공하면 3을 리턴한다
               참고 => https://github.com/green-labs/bootcamp-aoc/blob/main/translations/aoc2018/day3.md "
        (is (= 3 (solve-3-2 sample-string))))

      (testing "https://adventofcode.com/2018/day/3 의 part2 정답을 리턴한다"
