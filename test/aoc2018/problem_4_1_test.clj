(ns aoc2018.problem-4-1-test
  (:require [aoc2018.problem-4-1 :refer [to-sleep-datum to-day-log simplify-logs sample-input-string solve-4-1 input-strings]]
            [clojure.test :refer [deftest testing are is]]))

(deftest describe:to-sleep-datum
  (testing "to-sleep-datum 함수는
           잠들고 깨어난 로그를 받아 잠든 시간에 대한 map을 리턴합니다."
...
(deftest describe:to-day-log
  (testing "to-day-log 함수는
           하루의 로그를 분석해 map들의 리스트로 만들어 리턴합니다."
    (are [input-log result]
...
(deftest describe:simplify-logs
  (testing "simplify-logs 함수는
           주어진 로그 문자열을 시간순으로 정렬한 다음, 개별 로그로 재생성해 리턴합니다."
    (is (= (simplify-logs sample-input-string)
